...
training_documents_collection = 'shuffled_training_document_embedding_old'
testing_documents_collection = 'testing_document_embedding_old'
model_saved_name = "../TrainedNN/keras_nn_shuffled_mongo.model"
result_file_name = "../TrainedNN/result_nn_shuffled_mongo"
epochs = 20
layers = 2
...
model_factory = dl.factory.factory.create('KerasMultilayerPerceptron', num_class=len(ipc_sections), input_dim=(200,1), layers=1,
