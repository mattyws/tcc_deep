...
training_documents_collection = 'training_embedding_old_400'
testing_documents_collection = 'testing_embedding_old_400'
model_saved_name = "../TrainedLSTM/keras_rnn_old_400.model"
result_file_name = "../TrainedLSTM/results/result_rnn_old_400"
epochs = 20
layers = 2
