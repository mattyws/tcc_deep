...
training_documents_collection = 'training_document_embedding_mongo'
testing_documents_collection = 'testing_document_embedding_mongo'
model_saved_name = "../TrainedNN/keras_nn_mongo.model"
result_file_name = "../TrainedNN/result_nn_mongo"
epochs = 12
layers = 2
