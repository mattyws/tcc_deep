...
training_documents_collection = 'training_embedding_mongo_50'
testing_documents_collection = 'testing_embedding_mongo_50'
model_saved_name = "../TrainedConv/keras_cnn_mongo_50.model"
result_file_name = "../TrainedConv/results/result_cnn_mongo_50"
epochs = 20
layers = 1
