...
doc2vec_model = dl.learn.Doc2VecTrainer().load_model('../doc2vec_models/doc2vec_old_400.model')
...
for doc in shuffled:
    ...
    doc_embedding_collection = patents_database.training_document_embedding_old_400
