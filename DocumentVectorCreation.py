...
doc2vec_model = dl.learn.Doc2VecTrainer().load_model('../doc2vec_models/doc2vec_mongo_400.model')
...
for doc in shuffled:
    ...
    doc_embedding_vector = doc_vector_generator.create_x_text(content).reshape((1,400))
    client = pymongo.MongoClient()
    patents_database = client.patents
    doc_embedding_collection = patents_database.training_document_embedding_mongo_400
