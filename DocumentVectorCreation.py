...
new_collections = ['training_document_embedding_mongo_300_2', 'testing_document_embedding_mongo_300_2']
embedding_size = 300
doc2vec_model = dl.learn.Doc2VecTrainer().load_model('../doc2vec_models/doc2vec_mongo_300.model')
