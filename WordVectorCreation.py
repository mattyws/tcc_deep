...
word2vec_model = dl.learn.Word2VecTrainer().load_model('../word2vec_models/word2vec_400_mongo.model')
...
for doc in shuffled:
    ...
    word_embedding_collection = patents_database.training_embedding_mongo_400
