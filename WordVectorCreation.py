...
word2vec_model = dl.learn.Word2VecTrainer().load_model('../word2vec_models/word2vec_mongo.model')
...
for document in documents:
    ...
    word_embedding_collection = patents_database.testing_embedding_old_mongo
