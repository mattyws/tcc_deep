...
word2vec_model = dl.learn.Word2VecTrainer().load_model('../word2vec_models/word2vec_50.model')
...
for doc in shuffled:
    ...
    word_embedding_collection = patents_database.training_embedding_old_50
