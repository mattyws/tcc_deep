...
corpus = MongoLoadDocumentData('patents', documents, clean_text=True, tokenizer=tokenizer, stop_set=stop_set,description=True, remove_digits=True)

word2vec_model = dl.learn.Word2VecTrainer().load_model('../word2vec_models/word2vec_noDigits.model')
...
for document in documents:
    ...
    word_embedding_collection = patents_database.testing_embedding_noDigits
